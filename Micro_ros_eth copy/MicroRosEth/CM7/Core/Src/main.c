...
#include <stdlib.h> // Required for standard library functions
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  // by the RTOS init sequence if configured in CubeMX.
...
void MPU_Config(void)
{
  ...
  // This configuration is often needed for Ethernet Descriptors on H7
  MPU_InitStruct.Enable = MPU_REGION_ENABLE;
  MPU_InitStruct.Number = MPU_REGION_NUMBER0;
  MPU_InitStruct.BaseAddress = 0x30040000; // Ethernet RAM
  ...
  MPU_InitStruct.IsCacheable = MPU_ACCESS_NOT_CACHEABLE; // Ensure non-cacheable for DMA
